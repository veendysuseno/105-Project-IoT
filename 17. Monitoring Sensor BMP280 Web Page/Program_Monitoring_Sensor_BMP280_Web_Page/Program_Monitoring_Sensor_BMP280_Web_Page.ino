/***************************************
 * Project Monitoring Sensor BMP280 via Webpage
...
void loop() {
  ...
  client.println("<html>");
  client.println("<head>");
  client.println("<title>NodeMCU Weather Station</title>");
  ...
  client.println(".temperature .reading{color: #F29C1F;}");
  client.println(".humidity .reading{color: #3B97D3;}");
  client.println(".pressure .reading{color: #26B99A;}");
  client.println(".altitude .reading{color: #955BA5;}");
  ...
  client.println("</head>");
  client.println("<body>");
  client.println("<h1>NodeMCU Weather Station</h1>");
  client.println("<div class='container'>");
  client.println("<div class='data temperature'>");
  ...
  client.println("</div>");
  client.println("<div class='side-by-side text'>Temperature</div>");
  ...
  client.println("</div>");
  client.println("<div class='data pressure'>");
  client.println("<div class='side-by-side icon'>");
  client.println("<svg enable-background='new 0 0 40.542 40.541'height=40.541px id=Layer_1 version=1.1 viewBox='0 0 40.542 40.541'width=40.542px x=0px xml:space=preserve xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink y=0px><g><path d='M34.313,20.271c0-0.552,0.447-1,1-1h5.178c-0.236-4.841-2.163-9.228-5.214-12.593l-3.425,3.424");
  ...
  client.println("C23.196,19.843,23.464,20.973,23.084,22.037z'fill=#26B999 /></g></svg>");
  client.println("</div>");
  client.println("<div class='side-by-side text'>Pressure</div>");
  client.println("<div class='side-by-side reading'>");
  client.println((int)pressure);
  client.println("<span class='superscript'>hPa</span></div>");
  client.println("</div>");
  client.println("<div class='data altitude'>");
  client.println("<div class='side-by-side icon'>");
  client.println("<svg enable-background='new 0 0 58.422 40.639'height=40.639px id=Layer_1 version=1.1 viewBox='0 0 58.422 40.639'width=58.422px x=0px xml:space=preserve xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink y=0px><g><path d='M58.203,37.754l0.007-0.004L42.09,9.935l-0.001,0.001c-0.356-0.543-0.969-0.902-1.667-0.902");
  ...
  client.println("</div>");
  client.println("<div class='side-by-side text'>Altitude</div>");
  client.println("<div class='side-by-side reading'>");
  client.println((int)altitude);
  client.println("<span class='superscript'>m</span></div>");
  client.println("</div>");
  client.println("</div>");
  client.println("</body>");
  client.println("</html>");
